...
image_write(nic,"nicole.png") # this saves the image as a separate file
```
...
i like runif more, idrk y tho

```{r}

jumbleRed <- matrix(0,500,500)
jumbleGreen <- matrix(0,500,500)
jumbleBlue <- matrix(0,500,500)

for (i in 1:500){
  for (j in 1:500){
    jumbleRed[i,j] <- runif(1)
    jumbleGreen[i,j] <- runif(1)
    jumbleBlue[i,j] <- runif(1)
  }
}

jData <- array(c(jumbleRed,jumbleGreen,jumbleBlue),dim = c(500,500,3))

jumble <- image_read(jData) 
print(jumble)
...
```{r}
whaRed <- matrix(0,500,500)
whaGreen <- matrix(0,500,500)
whaBlue <- matrix(0,500,500)
...
whaData <- array(c(whaRed,whaGreen,whaBlue),dim = c(500,500,3))

wha <- image_read(whaData) 
print(wha)
```
