...
A <- aux.fisch(10)
```
What are its dimensions? Is it symmetric? How many nonzero entries does it have? Make a plot of its eigenvalues in the complex plane using the Re and Im commands. Which iterative solvers would be good choices for this $A$? 
